...
<template>
  <section class="h-full w-full flex flex-col items-center justify-center">
    <h1
      class="font-[Inter] text-balance mb-4 text-3xl lg:text-5xl text-center font-extrabold text-black"
    >
      Compartilhe e monetize trechos de código.
    </h1>
    <p
      class="font-[Inter] mb-8 text-balance text-xl lg:text-3xl text-center text-black"
    >
